package com.example.proyek1dts;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                confirmDeleteNotes(data.get("name").toString());
                return true;
            }
    ...
    protected void onResume() {
        ...
        void getFileList () {
            String path = Environment.getExternalStorageDirectory().toString() + "/dts.proyek1";
        ...
        void confirmDeleteNotes(final String filename){
            new AlertDialog.Builder(this)
                    .setTitle("Hapus Catatan Ini?")
                    .setMessage("Apakah Anda yakin ingin mengahpus catatan"+filename+?)
